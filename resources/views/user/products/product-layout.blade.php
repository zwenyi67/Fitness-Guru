    ...
    <div class="row p-3 py-4">
        ...
        <div class="col-lg-2 col-md-12">
            <div class="container pt-4">
                    <div class="dropdown mb-3 pt-2">
                            <a
                        class="dropdown-toggle filter-btn fs-5 text-white" href="#" role="button"
                        ...
                        <ul class="dropdown-menu" style="max-height: 300px; overflow-y: auto;">
                            <li>
                                <a class="dropdown-item  mt-2 {{ empty(request('category')) ? 'active' : '' }}"
                                    href="/products?{{ http_build_query(request()->except('category', 'page')) }}">
                                    Categories
                                </a>
                            </li>
                            @foreach ($categories as $category)
                                <li>
                                    <a class="dropdown-item  mt-2 {{ request('category') && request('category') == $category->id ? 'active' : '' }}"
                                        href="/products?category={{ $category->id }}&{{ http_build_query(request()->except('category', 'page')) }}">
                                        {{ $category->name }}
                                    </a>
                                </li>
                            @endforeach
        ...
        <div class="col-lg-4 col-md-12">
            <div class="container pt-4 mb-3">
                <div class="">
                    <form method="GET" action="/products/" class="input-group input-group-lg">
                    @if (request('category'))
