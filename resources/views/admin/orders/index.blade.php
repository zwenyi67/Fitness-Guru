<x-admin-layout>
                ...
                <div class="card-header navbar navbar-expand navbar-white navbar-light">
                    <ul class="navbar-nav d-flex">
                        <li class="nav-item d-none d-sm-inline-block border rounded mr-2">
                          <a href="#" class="nav-link px-3 text-primary">Orders</a>
                        </li>
                        <li class="nav-item d-none d-sm-inline-block border rounded mr-2">
    ...
    $(document).on('click', '.addButton', function(a) {
        a.preventDefault();
        var id = $(this).data('id');
        
        Swal.fire({
            title: 'Are you sure you want to add this order to delivery ?',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire(
                        'Success !',
                        'Order has been added to delivery.',
                        'success'
                    )
            }
        })
