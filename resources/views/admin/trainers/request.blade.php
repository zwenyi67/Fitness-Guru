<x-admin-layout>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header d-flex">
                    <h3 class="card-title text-center mr-auto">Trainers Table </h3>
                </div>
                <div class="card-header navbar navbar-expand navbar-white navbar-light">
                    <ul class="navbar-nav d-flex">
                        <li class="nav-item d-none d-sm-inline-block border rounded mr-2">
                          <a href="#" class="nav-link px-3 text-primary">Pending</a>
                        </li>
                        <li class="nav-item d-none d-sm-inline-block border rounded">
                          <a href="/admin/trainers/approve" class="nav-link px-3 ">Approved</a>
                        </li>
                      </ul>
                </div>
                ...
                <div class="card-body">
                    <table style="width: 100%" id="trainers" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Image</th>
    ...
    <script>
        var trainerTable = $('#trainers').DataTable({
            'serverSide': true,
            'processing': true,
            'ajax': {
                url: '/admin/trainers',
